...
class AuthenticationServiceTest {
    ...
    void createUser() {
        ...
        this.form.setAddressNumber("29");
        this.form.setAddressName("Rue Saint Germain");
        this.form.setPostalCode("91760");
        this.form.setCity("Itteville");
        ...
        User result = service.createUser(this.form);
